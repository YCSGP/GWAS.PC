...
#' and in controls, assuming recessive mode of inheritance.
...
#' @export
recessive.diff<-function(r,pA, ncase, nctrl, pD, error.mat.case,error.mat.ctrl)
{
  pa  = 1-pA
  paa = pa^2 # P(aa)
  pAa = 2*pa*pA
  pAA = pA^2
  pD.aa = pD / (paa + pAa + r*pAA) #P(D|aa)
  pD.Aa = pD.aa
  pD.AA = r*pD.aa
